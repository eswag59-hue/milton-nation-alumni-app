...
- **Screenshots:** upload your fresh Build 29 screenshots (Alex Demo account) — 6.9" + 6.1".
...
- [x] Full test suite passed on Build 29 (create-post, crisis, report/block, delete, isolation, staff view, multi-photo) — ✅ 0 showstoppers.
- [ ] Fresh screenshots uploaded.
- [ ] App Privacy questionnaire completed (section 1).
- [ ] Reviewer notes + demo account entered (section 2).
- [ ] Build 29 processed + selected.
